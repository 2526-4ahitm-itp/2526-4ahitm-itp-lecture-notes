...
die es ermöglicht, eingehende Datenpakete,
die an einer bestimmten Adresse und einem externen Port ankommen,
zu einem bestimmten Gerät und einem internen Port im privaten Netzwerk umzuleiten.
Sie ist notwendig, da Geräte in deinem privaten Netzwerk standardmäßig durch eine Firewall verborgen sind.
...
== 2026-03-01 [Hanan Mehic] - https://youtu.be/VnvRFRk_51k?si=rRKB7III4LPrLDov[What ist kubernetes (Nana)]
...
== 2026-03-09 [Clemens Zangenfeind]

=== Kriterien für ein gutes GUI
...
TIP: UI ist das design (Aussehen), UX ist die Nutzererfahrung (Interaktionen)

== 2026-02-23

== 2026-03-09 - User Interface [Simone Sperrer]
=== Kriterien für eine gute GUI
...
=== Was versteht man unter Informationshierarchie?
Informationshierarchie ist die strukturierte Anordnung und Priorisierung von Inhalten,
um Nutzern das Verständnis und das schnelle Auffinden von Informationen zu erleichtern.

=== UI Vs. UX
* *UI (User Interface)* bezieht sich auf die Gestaltung der Benutzeroberfläche,
also wie die Elemente angeordnet sind, welche Farben verwendet werden,
welche Schriftarten, ...
* *UX (User Experience)* bezieht sich auf die Gesamterfahrung des Nutzers,
einschließlich der Benutzerfreundlichkeit, der Effizienz und der Zufriedenheit.

=== Serif Vs. Sans-serif
* *Serif-Schriften* (mit Füßchen) sind ideal für gedruckte,
lange Texte (Bücher, Zeitungen), da sie die Zeilenführung unterstützen und klassisch/seriös wirken.
* *Sans-Serif-Schriften* (ohne Serifen) eignen sich besser für Bildschirme,
kurze Texte, Überschriften und moderne, minimalistische Designs (Websites, Apps, Logos).
...
@startmindmap
* ITP 4Jg.
**[#orange] Automatisierte Tests
***[#orange] Teststrategien
****[#orange]_ Grenzwertanalyse
****[#orange]_ Äquivalenzklassenanalyse
**[#orange] TDD
**[#orange] Deployment CI/CD
***[#orange] docker compose
***[#orange] k8s
****[#orange]_ Komponenten von k8s
****[#orange]_ Struktur eines yaml-Konfigurationsfiles
**[#orange] ui/ux
**[#orange] uml
***[#orange] class diagram
***[#orange] object diagram
***[#orange] ...
**[#orange] scrum
**[#orange] git
***[#orange] github-actions
**[#orange] docker (3,jg)
**[#orange] IAM-System
***[#orange] keycloak
****[#orange]_ Realms, Clients, Users, Roles, Groups
****[#orange]_ RBAC, PBAC
***[#orange] OAuth2, OpenID Connect, SAML
***[#orange] Arten von Token
***[#orange] Arten der Authentifizierung
****[#orange]_ SSO, WebAuthn, 2-Factor-Authentication, ...
**[#orange] AI
***[#orange] Agentisches Programmieren
****[#orange]_ Vorgehensweise (Fachspezifikation, Design)
****[#orange]_ Was ist der Context?
***[#orange] MCP
***[#orange] N8N u ähnliche Tools
@endmindmap
----
...
** https://openspec.dev[openspec]
** https://jsdoc.app/[jsdoc^]

** Es wird angemerkt, dass Grundlagen des Programmierens tw. fehlen:
*** zB Java: https://www.happycoders.eu/java/virtual-threads/[Virtuelle Threads^]
*** zB JS: https://developer.mozilla.org/en-US/docs/Web/API/Web_components/Using_shadow_DOM[Shadow DOM^], https://developer.mozilla.org/en-US/docs/Web/API/Web_components/Using_custom_elements[Custom Elements^], ...

== 2026-04-13 [Hanan Mehic]

=== Grundprinzip von LLMs
...
==== Ähnlichkeit von Bedeutungen (Cosinus)
...
image::../images/vektor-cos.png[]

Ziel beim Prompting:
*Prompt-Vektor ~ Ziel-Vektor*

==== “Tal”-Metapher (LLM-Verhalten)

* LLM verhält sich wie eine Landschaft (Loss Landscape)
* Ziel = Minimum (Tal)
* Antworten "rollen" Richtung sinnvollster Lösung

image::../images/loss-landscape.png[]
Gute Prompts = bessere Richtung ins Tal

==== Prompt als quadratische Funktion
...
image::../images/quadratische-fkt.png[]
...
Tipp:
Dinge als Kommentar markieren -> weniger Gewicht (z. B. "nur Idee")
